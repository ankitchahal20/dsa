...
public:
    ...
    int longestPalindromeSubseq(string s) {
        ...
        // recursive solution
        // return longestPalindromeSubseqRecursive(s, t, m, n);

        // recursive memoization
        // vector<vector<int>> dp(m+1, vector<int>(n+1, -1));
        // return longestPalindromeSubseqRecursiveMemoization(s, t, m, n, dp);

        // tabulation solution
        // return longestPalindromeSubseqTabulation(s, t, m, n);

        // tabulation space optimized solution
        return longestPalindromeSubseqSpaceOptimizedTabulation(s, t, m, n);
    }
};
